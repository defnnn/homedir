...
- "`]m`" : Move (forward) to the beginning of the _next_ Python method or function.
...
Note that you do not need to specify _all_ the key mappings if you just want to customize a few.
