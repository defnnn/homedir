...
class Events {
  ...
  public async fire(event: string, args: any[]): Promise<void> {
    ...
    if (event == "InsertEnter") {
      ...
      !this._insertMode &&
      (event == "CursorHoldI" || event == "CursorMovedI")
    ) {
      this._insertMode = true;
      void this.fire("InsertEnter", [args[0]]);
    } else if (
      this._insertMode &&
      (event == "CursorHold" || event == "CursorMoved")
    ) {
      this._insertMode = false;
  ...
  public on(
    event: BufEvents,
    handler: (bufnr: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: MoveEvents,
    handler: (bufnr: number, cursor: [number, number]) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: InsertChangeEvents,
    handler: (bufnr: number, info: InsertChange) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: WindowEvents,
    handler: (winid: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "TextInsert",
    handler: (bufnr: number, info: InsertChange, character: string) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "FloatBtnClick",
    handler: (bufnr: number, index: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "TextChanged",
    handler: (bufnr: number, changedtick: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "TaskExit",
    handler: (id: string, code: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "TaskStderr" | "TaskStdout",
    handler: (id: string, lines: string[]) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "BufReadCmd",
    handler: (scheme: string, fullpath: string) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "VimResized",
    handler: (columns: number, lines: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "Command",
    handler: (name: string) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "MenuPopupChanged",
    handler: (event: PopupChangeEvent, cursorline: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "CompleteDone",
    handler: (item: VimCompleteItem) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "InsertCharPre",
    handler: (character: string, bufnr: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "FileType",
    handler: (filetype: string, bufnr: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "BufWinEnter" | "BufWinLeave",
    handler: (bufnr: number, winid: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "DirChanged",
    handler: (cwd: string) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
  ...
  public on(
    event: "InputChar",
    handler: (session: string, character: string, mode: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: "PromptInsert",
    handler: (value: string, bufnr: number) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable;
  public on(
    event: AllEvents[] | AllEvents,
    handler: (...args: any[]) => Result,
    thisArg?: any,
    disposables?: Disposable[]
  ): Disposable {
