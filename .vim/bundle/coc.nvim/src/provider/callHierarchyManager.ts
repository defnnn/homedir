...
export default class CallHierarchyManager extends Manager<CallHierarchyProvider> {
  ...
  public async prepareCallHierarchy(
    ...
    return await Promise.resolve(
      provider.prepareCallHierarchy(document, position, token)
    );
  }
  ...
  public async provideCallHierarchyOutgoingCalls(
    ...
    return await Promise.resolve(
      provider.provideCallHierarchyOutgoingCalls(item, token)
    );
  }
  ...
  public async provideCallHierarchyIncomingCalls(
    ...
    return await Promise.resolve(
      provider.provideCallHierarchyIncomingCalls(item, token)
    );
  }
}
