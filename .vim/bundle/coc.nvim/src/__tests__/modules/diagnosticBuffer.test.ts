...
describe("diagnostic buffer", () => {
  ...
  describe("showVirtualText()", () => {
    beforeEach(async () => {
      ...
      config.virtualTextSrcId = await nvim.createNamespace(
        "diagnostics-virtualText"
      );
    });
    afterEach(() => {
