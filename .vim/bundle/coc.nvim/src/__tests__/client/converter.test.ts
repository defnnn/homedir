...
describe("converter", () => {
  ...
  it("should asWillSaveTextDocumentParams", () => {
    let res = cv.asWillSaveTextDocumentParams({
  ...
  it("should asCompletionParams", () => {
    let params = cv.asCompletionParams(
      createDocument(),
      Position.create(0, 0),
  ...
  it("should asTextDocumentPositionParams", () => {
    let params = cv.asTextDocumentPositionParams(
      createDocument(),
      Position.create(0, 0)
    );
    expect(params.textDocument).toBeDefined();
  ...
  it("should asReferenceParams", () => {
    let params = cv.asReferenceParams(createDocument(), Position.create(0, 0), {
