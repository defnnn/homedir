...
connection.onInitialize((params) => {
  ...
  assert.deepEqual(
    ...
    [
      vscode_languageserver_1.ResourceOperationKind.Create,
      vscode_languageserver_1.ResourceOperationKind.Rename,
      vscode_languageserver_1.ResourceOperationKind.Delete,
    ]
  );
  assert.equal(
    params.capabilities.workspace.workspaceEdit.failureHandling,
    vscode_languageserver_1.FailureHandlingKind.TextOnlyTransactional
  );
  assert.equal(
