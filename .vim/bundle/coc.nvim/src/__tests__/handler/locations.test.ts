...
describe("locations", () => {
  describe("reference", () => {
    beforeEach(() => {
      disposables.push(
        languages.registerReferencesProvider([{ language: "*" }], {
          provideReferences: () => {
    ...
    it("should get references", async () => {
      currLocations = [
        createLocation("foo", 0, 0, 0, 0),
        createLocation("bar", 0, 0, 0, 0),
      ];
  ...
  describe("declaration", () => {
    beforeEach(() => {
      disposables.push(
        languages.registerDeclarationProvider([{ language: "*" }], {
          provideDeclaration: () => {
            return currLocations;
          },
        })
  ...
  describe("implementation", () => {
    beforeEach(() => {
      disposables.push(
        languages.registerImplementationProvider([{ language: "*" }], {
