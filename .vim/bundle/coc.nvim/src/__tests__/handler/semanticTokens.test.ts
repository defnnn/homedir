      ...
      [{ language: "rust" }],
      {
        provideDocumentSemanticTokens: () => {
          return {
            resultId: "1",
            data: [
              0, 0, 2, 1, 0, 0, 3, 4, 14, 2, 0, 4, 1, 41, 0, 0, 1, 1, 41, 0, 0,
              2, 1, 25, 0, 1, 4, 8, 17, 0, 0, 8, 1, 41, 0, 0, 1, 3, 2, 0, 0, 3,
              1, 41, 0, 0, 1, 1, 44, 0, 1, 0, 1, 25, 0,
            ],
          };
        },
      },
...
describe("semanticTokens", () => {
  describe("triggerSemanticTokens", () => {
    ...
    it("should doHighlight", async () => {
      ...
      const highlights = await nvim.call("coc#highlight#get_highlights", [
        doc.bufnr,
        "semanticTokens",
      ]);
      expect(highlights.length).toBe(11);
