...
export class CommandManager implements Disposable {
  ...
  public init(nvim: Neovim, plugin: Plugin): void {
    ...
    this.register(
      {
        ...
        execute: async (edit: TextEdit) => {
          ...
          return await snipetsManager.insertSnippet(
            edit.newText,
            true,
            edit.range
          );
    ...
    this.register(
      {
        ...
        execute: async () => {
          ...
          if (res.success)
            window.showMessage("Cleared watchman watching directories.");
        },
      },
      false,
      "run watch-del-all for watchman to free up memory."
    );
    this.register(
      {
    ...
    this.register(
      ...
      false,
      "change current filename to a new name and reload it."
    );
    this.register(
      {
    ...
    this.register(
      ...
      false,
      "jump to related locations of current diagnostic."
    );
    this.register(
      {
      ...
      false,
      "open output buffer to show output from languageservers or extensions."
    );
    this.register(
      {
      ...
      false,
      "show incoming calls in tree view."
    );
    this.register(
      {
      ...
      false,
      "show outgoing calls in tree view."
    );
    this.register(
      {
      ...
      false,
      "echo the mapped filetype of the current buffer"
    );
    this.register(
      {
      ...
      false,
      "rename word under cursor in current buffer by use multiple cursors."
    );
    this.register(
      {
      ...
      false,
      "Jump to next symbol highlight position."
    );
    this.register(
      {
    ...
    this.register(
      ...
      false,
      "Jump to previous symbol highlight position."
    );
  }
  ...
  public async addRecent(cmd: string): Promise<void> {
    ...
    await workspace.nvim.command(
      `silent! call repeat#set("\\<Plug>(coc-command-repeat)", -1)`
    );
  }
