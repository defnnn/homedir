...
export default class Symbols extends LocationList {
  ...
  public readonly detail =
    "Symbols list is provided by server, it works on interactive mode only.";
  private cwd: string;
  public name = "symbols";
  public options = [
    {
  ...
  public doHighlight(): void {
    ...
    nvim.command(
      "syntax match CocSymbolsName /\\v^\\s*\\S+/ contained containedin=CocSymbolsLine",
      true
    );
    nvim.command(
      "syntax match CocSymbolsKind /\\[\\w\\+\\]\\s*\\t/ contained containedin=CocSymbolsLine",
      true
    );
    nvim.command(
      "syntax match CocSymbolsFile /\\S\\+$/ contained containedin=CocSymbolsLine",
      true
    );
