...
export function convertToTextDocumentItem(
...
export function asChangeTextDocumentParams(
  document: TextDocument
): DidChangeTextDocumentParams {
...
export function asWillSaveTextDocumentParams(
...
export function asVersionedTextDocumentIdentifier(
...
export function asSaveTextDocumentParams(
  document: TextDocument,
  includeText: boolean
): DidSaveTextDocumentParams {
...
export function asTextDocumentPositionParams(
  textDocument: TextDocument,
  position: Position
): TextDocumentPositionParams {
  return {
...
export function asSignatureHelpParams(
  textDocument: TextDocument,
  position: Position,
...
export function asTextDocumentIdentifier(
  textDocument: TextDocument
): TextDocumentIdentifier {
  return {
    uri: textDocument.uri,
...
export function asReferenceParams(
  textDocument: TextDocument,
  position: Position,
...
export function asDocumentSymbolParams(
  textDocument: TextDocument
): DocumentSymbolParams {
  return {
    textDocument: {
