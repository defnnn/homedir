...
export class DeclarationFeature extends TextDocumentFeature<
...
> {
  ...
  protected registerLanguageProvider(
        ...
        const provideDeclaration: ProvideDeclarationSignature = (
          ...
          client
            .sendRequest(
              ...
              asTextDocumentPositionParams(document, position),
              token
            )
            .then(
              (res) => res,
    ...
    return [
      languages.registerDeclarationProvider(options.documentSelector, provider),
      provider,
    ];
  }
}
