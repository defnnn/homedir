...
export class WorkspaceFoldersFeature implements DynamicFeature<void> {
  ...
  private doSendEvent(
    addedFolders: ReadonlyArray<WorkspaceFolder>,
    removedFolders: ReadonlyArray<WorkspaceFolder>
  ): void {
  ...
  protected sendInitialEvent(
    currentWorkspaceFolders: ReadonlyArray<WorkspaceFolder> | undefined
  ): void {
    if (this._initialFolders && currentWorkspaceFolders) {
      const removed: WorkspaceFolder[] = arrayDiff(
        this._initialFolders,
        currentWorkspaceFolders
      );
      const added: WorkspaceFolder[] = arrayDiff(
        currentWorkspaceFolders,
        this._initialFolders
      );
