...
export class SnippetVariableResolver implements VariableResolver {
  ...
  constructor() {
    ...
    Object.assign(this._variableToValue, {
      ...
      CURRENT_DAY_NAME: currentDate.toLocaleString("en-US", {
        weekday: "long",
      }),
      CURRENT_DAY_NAME_SHORT: currentDate.toLocaleString("en-US", {
        weekday: "short",
      }),
      CURRENT_MONTH_NAME: currentDate.toLocaleString("en-US", {
        month: "long",
      }),
      CURRENT_MONTH_NAME_SHORT: currentDate.toLocaleString("en-US", {
        month: "short",
      }),
      TM_FILENAME: null,
