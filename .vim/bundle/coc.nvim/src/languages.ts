...
class Languages {
  ...
  public readonly onDidSemanticTokensRefresh: Event<DocumentSelector> =
    this._onDidSemanticTokensRefresh.event;
  ...
  public registerOnTypeFormattingEditProvider(
    ...
    return this.onTypeFormatManager.register(
      selector,
      provider,
      triggerCharacters
    );
  ...
  public registerCompletionItemProvider(
    ...
    selector =
      typeof selector == "string" ? [{ language: selector }] : selector;
  ...
  public registerCodeActionProvider(
    ...
    return this.codeActionManager.register(
      selector,
      provider,
      clientId,
      codeActionKinds
  ...
  public registerSignatureHelpProvider(
    ...
    return this.signatureManager.register(
      selector,
      provider,
      triggerCharacters
    );
  ...
  public registerDocumentSymbolProvider(
    ...
    return this.documentSymbolManager.register(
      selector,
      provider,
      metadata?.label
    );
  ...
  public registerReferencesProvider(
    selector: DocumentSelector,
  ...
  public registerWorkspaceSymbolProvider(
    ...
    if (
      arguments.length > 1 &&
      typeof arguments[1].provideWorkspaceSymbols === "function"
    ) {
  ...
  public registerDocumentFormatProvider(
    selector: DocumentSelector,
  ...
  public registerDocumentRangeFormatProvider(
    selector: DocumentSelector,
  ...
  public registerDocumentSemanticTokensProvider(
    selector: DocumentSelector,
    provider: DocumentSemanticTokensProvider,
    legend: SemanticTokensLegend
  ): Disposable {
    this._onDidSemanticTokensRefresh.fire(selector);
    return this.semanticTokensManager.register(
      selector,
      provider,
      legend,
      () => {
  ...
  public registerDocumentRangeSemanticTokensProvider(
    selector: DocumentSelector,
  ...
  public shouldTriggerSignatureHelp(
  ...
  public async getSignatureHelp(
    ...
    return await this.signatureManager.provideSignatureHelp(
      document,
      position,
      token,
      context
  ...
  public async getDefinition(
    ...
    return await this.definitionManager.provideDefinition(
      document,
      position,
      token
    );
  ...
  public async getDefinitionLinks(
    document: TextDocument,
    position: Position,
    token: CancellationToken
  ): Promise<DefinitionLink[]> {
    if (!this.definitionManager.hasProvider(document)) return null;
    return await this.definitionManager.provideDefinitionLinks(
      document,
      position,
      token
    );
  ...
  public async getDeclaration(
    ...
    return await this.declarationManager.provideDeclaration(
      document,
      position,
      token
    );
  ...
  public async getTypeDefinition(
    ...
    return await this.typeDefinitionManager.provideTypeDefinition(
      document,
      position,
      token
    );
  ...
  public async getImplementation(
    ...
    return await this.implementationManager.provideReferences(
      document,
      position,
      token
    );
  ...
  public async getReferences(
    ...
    return await this.referenceManager.provideReferences(
      document,
      position,
      context,
      token
  ...
  public async getDocumentSymbol(
    document: TextDocument,
    token: CancellationToken
  ): Promise<SymbolInformation[] | DocumentSymbol[]> {
    return await this.documentSymbolManager.provideDocumentSymbols(
      document,
      token
    );
  }

  public async getSelectionRanges(
    document: TextDocument,
    positions: Position[],
    token
  ): Promise<SelectionRange[] | null> {
    return await this.selectionRangeManager.provideSelectionRanges(
      document,
      positions,
      token
    );
  ...
  public async getWorkspaceSymbols(
    ...
    query = query || "";
    return await this.workspaceSymbolsManager.provideWorkspaceSymbols(
      query,
      token
    );
  }
  ...
  public async resolveWorkspaceSymbol(
    ...
    return await this.workspaceSymbolsManager.resolveWorkspaceSymbol(
      symbol,
      token
    );
  }
  ...
  public async provideRenameEdits(
    ...
    return await this.renameManager.provideRenameEdits(
      document,
      position,
      newName,
      token
  ...
  public async provideDocumentFormattingEdits(
    ...
    return await this.formatManager.provideDocumentFormattingEdits(
      document,
      options,
      token
    );
  ...
  public async provideDocumentRangeFormattingEdits(
    ...
    return await this.formatRangeManager.provideDocumentRangeFormattingEdits(
      document,
      range,
      options,
      token
  ...
  public async getCodeActions(
    ...
    return await this.codeActionManager.provideCodeActions(
      document,
      range,
      context,
      token
  ...
  public async getDocumentHighLight(
    document: TextDocument,
    position: Position,
    token: CancellationToken
  ): Promise<DocumentHighlight[]> {
    return await this.documentHighlightManager.provideDocumentHighlights(
      document,
      position,
      token
    );
  ...
  public async getDocumentLinks(
    ...
    return (
      (await this.documentLinkManager.provideDocumentLinks(document, token)) ||
      []
    );
  }
  ...
  public async provideDocumentColors(
    ...
    return await this.documentColorManager.provideDocumentColors(
      document,
      token
    );
  }
  ...
  public async provideFoldingRanges(
    ...
    return await this.foldingRangeManager.provideFoldingRanges(
      document,
      context,
      token
    );
  ...
  public async provideColorPresentations(
    ...
    return await this.documentColorManager.provideColorPresentations(
      color,
      document,
      token
    );
  ...
  public async provideDocumentOnTypeEdits(
    ...
    return this.onTypeFormatManager.onCharacterType(
      character,
      document,
      position,
      token
  ...
  public async prepareCallHierarchy(
    ...
    return this.callHierarchyManager.prepareCallHierarchy(
      document,
      position,
      token
    );
  ...
  public async provideIncomingCalls(
    ...
    return this.callHierarchyManager.provideCallHierarchyIncomingCalls(
      document,
      item,
      token
    );
  ...
  public async provideOutgoingCalls(
    ...
    return this.callHierarchyManager.provideCallHierarchyOutgoingCalls(
      document,
      item,
      token
    );
  ...
  public async provideDocumentSemanticTokens(
    ...
    return this.semanticTokensManager.provideDocumentSemanticTokens(
      document,
      token
    );
  }
  ...
  public async provideDocumentSemanticTokensEdits(
    ...
    return this.semanticTokensManager.provideDocumentSemanticTokensEdits(
      document,
      previousResultId,
      token
    );
  ...
  public async provideDocumentRangeSemanticTokens(
    ...
    return this.semanticTokensRangeManager.provideDocumentRangeSemanticTokens(
      document,
      range,
      token
    );
  ...
  public async provideLinkedEdits(
    document: TextDocument,
    position: Position,
    token: CancellationToken
  ): Promise<LinkedEditingRanges> {
    return this.linkedEditingManager.provideLinkedEditingRanges(
      document,
      position,
      token
    );
  ...
  public hasProvider(id: string, document: TextDocument): boolean {
    switch (id) {
      ...
      case "format":
        return (
          this.formatManager.hasProvider(document) ||
          this.formatRangeManager.hasProvider(document)
        );
      case "codeAction":
