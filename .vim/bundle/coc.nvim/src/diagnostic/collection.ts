...
export default class DiagnosticCollection {
  ...
  public readonly onDidDiagnosticsChange: Event<string> =
    this._onDidDiagnosticsChange.event;

  constructor(public readonly name: string, private onDispose?: () => void) {}

  public set(uri: string, diagnostics: Diagnostic[] | undefined): void;
  public set(entries: [string, Diagnostic[] | undefined][]): void;
  public set(
    entries: [string, Diagnostic[] | undefined][] | string,
